...
par(mfrow=c(1,2),mar=c(5,7.2,4.1,0.5),mgp=c(4, 1, 0))

boxplot(results[,"BFH.1"]/results[,"UFH.1"]~results[,"rho.v"],ylab="RE",xlab=expression(rho[v]),ylim=c(0.2,1),outline=FALSE,
        main="First Variable",cex.axis=1.5, cex.lab = 1.5, cex.main=1.5)
boxplot(results[,"BFH.2"]/results[,"UFH.2"]~results[,"rho.v"],ylab="RE",xlab=expression(rho[v]),ylim=c(0.2,1),outline=FALSE,
        main="Second Variable",cex.axis=1.5, cex.lab = 1.5, cex.main=1.5)
...
boxplot(results[,"BFH.1"]/results[,"UFH.1"]~results[,"rho.e"],ylab="RE",xlab= expression(rho[e]),ylim=c(0.2,1),outline=FALSE,
        main="First Variable",cex.axis=1.5, cex.lab = 1.5, cex.main=1.5)
boxplot(results[,"BFH.2"]/results[,"UFH.2"]~results[,"rho.e"],ylab="RE",xlab=expression(rho[e]),ylim=c(0.2,1),outline=FALSE,
        main="Second Variable",cex.axis=1.5, cex.lab = 1.5, cex.main=1.5)
...
# boxplot of relative efficiency against ratio R
pdf("RENRatioR.pdf", width = 20, height = 10)
par(mfrow=c(1,2), mar=c(5,7.2,4.1,0.5),mgp=c(4, 1, 0),las=2) 

boxplot(results[,"BFH.1"]/results[,"UFH.1"]~results[,"ratio"], ylab="RE",xlab="R",ylim=c(0.2,1),outline=FALSE,
        main="First Variable",cex.axis=1.5, cex.lab = 1.5, cex.main=1.7)
boxplot(results[,"BFH.2"]/results[,"UFH.2"]~results[,"ratio"], ylab="RE",xlab= "R", ylim=c(0.2,1),outline=FALSE,
        main="Second Variable",cex.axis=1.5, cex.lab = 1.5, cex.main=1.7)
...
sub.results<-(results$rho.e==0.7) & (results$rho.v==0.7)  # subsection of results
plot(results$ratio[sub.results],results$gain.1[sub.results],log="x",xlab="R",ylab="RE",main="First Variable",cex.axis=1.5, cex.lab = 1.6, cex.main=1.7) 
sub.results<-(results$rho.e==0.7) & (results$rho.v==0.7)  # subsection of results
plot(results$ratio[sub.results],results$gain.2[sub.results],log="x",xlab="R",ylab="RE",main="Second Variable",cex.axis=1.5, cex.lab = 1.6, cex.main=1.7) 
...
sub.results<-(results$rho.e==0.1) & (results$rho.v==0.7)  # subsection of results
...
sub.results<-(results$rho.e==0.1) & (results$rho.v==0.7)  # subsection of results
plot(results$ratio[sub.results],results$gain.2[sub.results],log="x",xlab="R",ylim=c(0.2,1),ylab="RE",main="Second Variable",cex.axis=1.5, cex.lab = 1.5, cex.main=1.7) 
...
sub.results<-(results$rho.e==0.7) & (results$rho.v==0.1)  # subsection of results.2
plot(results$ratio[sub.results],results$gain.1[sub.results],log="x",xlab="R",ylim=c(0.2,1),ylab="RE",main="First Variable",cex.axis=1.5, cex.lab = 1.5, cex.main=1.7) 
sub.results<-(results$rho.e==0.7) & (results$rho.v==0.1)  # subsection of results.2
plot(results$ratio[sub.results],results$gain.2[sub.results],log="x",xlab="R",ylim=c(0.2,1),ylab="RE",main="Second Variable",cex.axis=1.5, cex.lab = 1.5, cex.main=1.7) 
